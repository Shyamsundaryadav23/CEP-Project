...
import com.example.myhealth.databinding.ViewholderTopDoctor2Binding
...
class TopDoctorAdapter2 (val items:MutableList<DoctorModel>): RecyclerView.Adapter<TopDoctorAdapter2.Viewholder>(){
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.binding.specialTxt2.text = items[position].Special
        ...
        Glide.with(holder.itemView.context)
            ...
            .into(holder.binding.profileImg2)
